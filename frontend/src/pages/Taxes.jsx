...
export function Taxes() {
    ...
    return (
        <div className="bg-blue h-screen font-montserrat w-full overflow-hidden">
            <div className='p-4 flex flex-col justify-center items-center w-full'>
                ...
                <div className='flex flex-col pt-40 justify-center items-center gap-2'>
                    <h2 className='font-bold text-white text-xl'>Selecione o período desejado</h2>
                    <Date />
                </div>

            </div>
            <div className='bg-darkblue text-white flex gap-4 px-1 py-3 w-full mt-20'>
            ...
            <div className="bg-darkblue text-white px-1 py-3 w-full absolute bottom-0 flex justify-center items-center font-bold">
